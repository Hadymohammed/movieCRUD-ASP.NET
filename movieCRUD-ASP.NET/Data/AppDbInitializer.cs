using movieCRUD_ASP.NET.Data.Enum;
            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Cinemas.Any())
                {
                    context.Cinemas.AddRange(new List<Cinema>()
                    {
                        new Cinema()
                        {
                            ...
                            Bio = "This is the Bio of the first cinema"
                        },
                        new Cinema()
                        {
                            Name = "Cinema 2",
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        {
                            Name = "Life",
                            Description = "This is the Life movie Bio",
                            Price = 39.50,
                        ...
                        new Movie()
                        {
                            ...
                            Description = "This is the Shawshank Redemption Bio",
                            Price = 29.50,
                        ...
                        {
                            Name = "Ghost",
                            Description = "This is the Ghost movie Bio",
                            Price = 39.50,
                        ...
                        {
                            Name = "Race",
                            Description = "This is the Race movie Bio",
                            Price = 39.50,
                        ...
                        {
                            Name = "Scoob",
                            Description = "This is the Scoob movie Bio",
                            Price = 39.50,
                        ...
                        {
                            Name = "Cold Soles",
                            Description = "This is the Cold Soles movie Bio",
                            Price = 39.50,
